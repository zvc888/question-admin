...
import com.question.admin.domain.entity.exam.file.UploadResultVM;
import com.question.admin.service.exam.FileUpload;
import com.question.admin.domain.entity.exam.file.UeditorConfigVM;
    ...
    public Object upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (action.equals(IMAGE_UPLOAD)) {
            try {
                ...
                uploadResultVM.setUrl(fileUpload.getDownloadUrl(filePath));
